...
export default function Settings() {
  ...
  return (
    <Shell profile={profile} roleLabel={roleLabel} nav={nav}>
      <div className="page-head"><div><span onClick={() => router.push("/settings")} style={{ cursor: "pointer", color: "var(--faint)", fontSize: 13 }}>← Settings</span><h1 style={{ fontSize: 24, marginTop: 2 }}>Ask Velvet training</h1></div><span className="pill p-agency">{roleLabel}</span></div>
